...
public class SavingsProductDataValidator {
    ...
    private static final Set<String> SAVINGS_PRODUCT_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(
            ...
            SavingsApiConstants.accountingRuleParamName, SavingsApiConstants.chargesParamName, SavingProductAccountingParams.FEES_RECEIVABLE.getValue(),
            ...
            SavingProductAccountingParams.PAYMENT_CHANNEL_FUND_SOURCE_MAPPING.getValue(), SavingProductAccountingParams.INTEREST_PAYABLE.getValue(),
